...
public class BitmapToolkit {
    ...
    public   static String DIR_DEFAULT   ;

    public static void init(Application context)
    {
        DIR_DEFAULT=context.getExternalCacheDir().toString()+File.separator;
...
//    }
     ...
     * 获取图片
     */
    public static Bitmap loadLocalBitmapRoughScaled(String path, int maxHeight) {
        Bitmap bm = null;
        ...
        try {
            ...
            int be = options.outHeight / (maxHeight / 10);
            if (be % 10 != 0)
                be += 10;
